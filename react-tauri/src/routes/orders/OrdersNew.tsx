    ...
    return (
        <div className="p-8 max-w-3xl mx-auto">
            <div className="mb-8">
                ...
                <h1 className="text-3xl font-bold text-gray-900">{t.orders.newOrder}</h1>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    <h2 className="text-lg font-bold mb-4">{t.forms.customerInfo}</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">{t.forms.fullName} *</label>
                            <input
                                required
                                type="text"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">{t.forms.wilaya}</label>
                            <input
                                type="text"
                                className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    <h2 className="text-lg font-bold mb-4">{t.forms.vehicleDetails}</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">{t.forms.budget}</label>
                            <input
                                type="text"
                                className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">{t.forms.customBudget}</label>
                            <input
                                type="text"
                                className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
