    ...
    return (
        <div className="p-8 max-w-4xl mx-auto">
            <div className="mb-8">
                ...
                <h1 className="text-3xl font-bold text-gray-900">{t.inventory.addCar}</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="mb-6">
                        <label className="block text-sm font-medium text-gray-700 mb-2">{t.forms.photos}</label>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">{t.forms.video}</label>
