...
export default function AssignCarModal({ car, isOpen, onClose, onAssign }: AssignCarModalProps) {
    ...
    // const getOrderData = (key: string) => order?.order_data?.[key] || '' // Unused
    ...
    const handleAssign = async () => {
        ...
        try {
            ...
            // 2. Fetch Order and Update Logic
            ...
            if (selectedOrder) {
                ...
                try {
                    ...
                    const transactionData = {
                        id: uuidv4(),
                        type: 'Income', // Explicitly set type to Income
                        category: 'Car Sale',
                        ...
                        payment_method: 'cash',
                        related_car_id: car.id, // ID is string, matches schema
                        related_order_id: selectedOrderId.toString(), // ensure string
                        car_brand: car.brand,
                        car_model: car.model,
                    ...
                    console.error('Transaction preparation error:', trxEx)
